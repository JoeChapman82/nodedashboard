(function() {
  ...
  var canvas = document.getElementById("pieChartDisplay");
  var ctx = canvas.getContext("2d");

  // grab data
  var pieChartData = document.getElementById('pieChartData');
  var title = pieChartData.getAttribute('data-title');
  var xLabel = pieChartData.getAttribute('data-x');
  var yLabel = pieChartData.getAttribute('data-y');
  var data = $('#dataTable');
